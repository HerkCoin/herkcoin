...
uint256 hashGenesisBlock("0x35cc83c4647d8ab1c385c67a3ac7ff2f887437fdb780b56051ca600a385a6d70");
...
const string strMessageMagic = "HerkCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // HerkCoin: 0.35 days
static const int64 nTargetSpacing = 120; // HerkCoin: 15 seconds
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal herkcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "HerkCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xe5bb1cd5a3edf81de22e6f9cb965649a66912d12361ec44ecc330cc6d98cbd10");
    }
	...
	// vMerkleTree: 5a2e19825b
        ...
        block.nVersion = 1;
        block.nTime    = 1392242805;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1622884;

        if (fTestNet)
        {
            block.nTime    = 1392209479;
